...
| Phase 1 功能修复 | `8cad5fd`（显示候选分差）、`a5cc738`（预览期间禁止刷新设备） |
...
| `P1-UI-04` | 抓拍本人得到 Known，并显示检测框、相似度、候选分差和耗时 | 通过 | `Phase1_Camera_User` 得分 1.000、第二候选 0.073、返回有效 bbox，耗时 717.90 ms；结果文本行为测试覆盖候选分差和耗时。 |
